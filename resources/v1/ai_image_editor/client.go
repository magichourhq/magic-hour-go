...
func (c *Client) Create(request CreateRequest, reqModifiers ...RequestModifier) (types.V1AiImageEditorCreateResponse, error) {
	// URL formatting
	targetUrl, err := c.coreClient.BuildURL("/v1/" + "ai-image-editor")
	if err != nil {
	...
	if resp.StatusCode >= 300 {
		return types.V1AiImageEditorCreateResponse{}, sdkcore.NewApiError(*req, *resp)
	}
	...
	var bodyData types.V1AiImageEditorCreateResponse
