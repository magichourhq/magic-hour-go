...
| `└─ EndImageFilePath` |    ✗     |     —      | The image to use as the last frame of the video. * **`ltx-2`**: Not supported * **`seedance`**: Supports 480p, 720p, 1080p. * **`kling-2.5`**: Supports 1080p. * **`kling-3.0`**: Supports 1080p. * **`sora-2`**: Not supported * **`veo3.1`**: Not supported Legacy models: * **`kling-1.6`**: Not supported                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | `"api-assets/id/1234.png"`                                                                                                                |
