...
| `└─ EndImageFilePath` |    ✗     |     —      | The image to use as the last frame of the video. * **`ltx-2.3`**: Supports 480p, 720p, 1080p. * **`wan-2.2`**: Not supported * **`kling-2.5`**: Supports 1080p. * **`kling-3.0`**: Supports 720p, 1080p, 4k. * **`veo3.1-lite`**: Not supported * **`veo3.1`**: Not supported * **`seedance`**: Not supported * **`seedance-2.0`**: Supports 480p, 720p. * **`sora-2`**: Not supported                                                                                                                                                                                                                                                                                                                                                                                                 | `"api-assets/id/1234.png"`                                                                                                                |
