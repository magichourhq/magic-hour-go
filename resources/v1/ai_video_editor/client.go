...
func (c *Client) Create(request CreateRequest, reqModifiers ...RequestModifier) (types.V1AiVideoEditorCreateResponse, error) {
	// URL formatting
	targetUrl, err := c.coreClient.BuildURL("/v1/" + "ai-video-editor")
	if err != nil {
		return types.V1AiVideoEditorCreateResponse{}, err
	}
	...
	if resp.StatusCode >= 300 {
		return types.V1AiVideoEditorCreateResponse{}, sdkcore.NewApiError(*req, *resp)
	}
	...
	var bodyData types.V1AiVideoEditorCreateResponse
