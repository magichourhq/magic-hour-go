...
func (c *Client) Delete(request DeleteRequest, reqModifiers ...RequestModifier) error {
	// URL formatting
	targetUrl, err := c.coreClient.BuildURL("/v1/" + "audio-projects/" + sdkcore.FmtStringParam(request.Id))
	if err != nil {
		return err
	}
...
func (c *Client) Get(request GetRequest, reqModifiers ...RequestModifier) (types.V1AudioProjectsGetResponse, error) {
	// URL formatting
	targetUrl, err := c.coreClient.BuildURL("/v1/" + "audio-projects/" + sdkcore.FmtStringParam(request.Id))
	if err != nil {
		return types.V1AudioProjectsGetResponse{}, err
	}
	...
	// Check status
	if resp.StatusCode >= 300 {
		return types.V1AudioProjectsGetResponse{}, sdkcore.NewApiError(*req, *resp)
	}
	...
	var bodyData types.V1AudioProjectsGetResponse
