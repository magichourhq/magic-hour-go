...
type CreateRequest struct {
    ...
    Assets types.PostV1VideoToVideoBodyAssets `json:"assets"`
    ...
    FpsResolution nullable.Nullable[types.PostV1VideoToVideoBodyFpsResolutionEnum] `json:"fps_resolution,omitempty"`
    ...
    Style types.PostV1VideoToVideoBodyStyle `json:"style"`
