...
func (c *Client) Create(request CreateRequest, reqModifiers ...RequestModifier) (types.V1AudioToVideoCreateResponse, error) {
	// URL formatting
	targetUrl, err := c.coreClient.BuildURL("/v1/" + "audio-to-video")
	if err != nil {
		return types.V1AudioToVideoCreateResponse{}, err
	}

	// Prep body
	reqBodyBuf := &bytes.Buffer{}
	reqBody, err := json.Marshal(types.V1AudioToVideoCreateBody{
		Name:         request.Name,
	...
	if resp.StatusCode >= 300 {
		return types.V1AudioToVideoCreateResponse{}, sdkcore.NewApiError(*req, *resp)
	}
	...
	var bodyData types.V1AudioToVideoCreateResponse
