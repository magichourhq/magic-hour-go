...
type GetV1VideoProjectsIdResponseTypeEnum string
const (
    ...
    GetV1VideoProjectsIdResponseTypeEnumTextToVideo GetV1VideoProjectsIdResponseTypeEnum = "TEXT_TO_VIDEO"
    GetV1VideoProjectsIdResponseTypeEnumVideoToVideo GetV1VideoProjectsIdResponseTypeEnum = "VIDEO_TO_VIDEO"
)
